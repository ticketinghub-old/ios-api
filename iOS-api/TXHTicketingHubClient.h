...
- (void)availabilitiesForProduct:(TXHProduct *)product dateString:(NSString *)dateString tickets:(NSArray *)tickets couponCode:(NSString *)coupon completion:(void(^)(NSArray *availabilities, NSError *error))completion;/** Update the availabilities for a product for a day or a range of days.
